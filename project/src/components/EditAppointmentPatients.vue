<template>
  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <form @submit.prevent="rescheduleAppointment" class="shadow p-4">
          <h4 class="mb-4 text-center">Reschedule Appointment</h4>
          <!-- Form fields for appointment data -->
          <div class="mb-3">
            <input type="date" class="form-control" v-model="this.appointment_date"
...
export default {
  ...
  methods: {
    rescheduleAppointment() {
      ...
      axios.patch(`${BASE_URL}/patient/appointment/reschedule/${this.$route.params.id}`, { appointment_date: this.appointment_date })
        .then(() => {
          this.clearForm();
          Swal.fire({
            icon: 'success',
            title: 'Appointment updated successfully!',
            text: 'You have successfully updated a appointment.',
        ...
        .catch(error => {
          Swal.fire({
            ...
            text: error.response.data.error.appointment_date,
            confirmButtonText: 'OK'
          });
          console.log(error)
        });
